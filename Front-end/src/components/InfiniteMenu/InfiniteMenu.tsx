...
class InfiniteGridMenu {
  ...
  private render(): void {
    ...
    gl.clearColor(0.0667, 0.0941, 0.1529, 1.0);
...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [] }) => {
  ...
  return (
    <div className="pl-140 flex items-start">
      <div className="relative top-20 bottom-20 bg-slate-900 overflow-x-visible overflow-y-visible py-39 w-[70%] h-[600px]">
        <canvas
          id="infinite-grid-menu-canvas "
          ref={canvasRef}
          className="cursor-grab w-full h-full relative  active:cursor-grabbing"
        />
        ...
        `}
          ...
          ${
            isMoving
              ? "opacity-0 pointer-events-none duration-[100ms] translate-x-[-80%] -translate-y-1/2"
