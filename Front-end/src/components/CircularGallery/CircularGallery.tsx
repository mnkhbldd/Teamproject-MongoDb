...
function autoBind(instance: object): void {
  ...
  Object.getOwnPropertyNames(proto).forEach((key) => {
    ...
    if (
      ...
      // @ts-expect-error: binding dynamic method to instance
...
class Media {
  ...
  onResize({
    ...
    this.scale = this.screen.height / 500;
    this.plane.scale.y =
...
export default function CircularGallery({
  ...
  return (
    <div
      className="w-full h-fit flex object-contain pt-15 bg-slate-900 overflow-hidden cursor-grab active:cursor-grabbing"
      ref={containerRef}
    />
  );
}
